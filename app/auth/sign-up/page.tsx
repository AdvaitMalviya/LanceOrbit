    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <Card className="p-8 border-glow bg-card/80 backdrop-blur">
          <h1 className="text-3xl font-bold mb-2 text-center">Join LanceOrbit</h1>
          <p className="text-center text-muted-foreground mb-8">Create your freelance profile</p>
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <div>
              <label className="text-sm font-medium block mb-2">Repeat Password</label>
              <Input
                type="password"
                placeholder="••••••••"
